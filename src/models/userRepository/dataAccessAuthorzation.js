...
const agents = {
  ...
  agent: {
    ...
    speciality: [customer, agent, admin, superAdmin, anonymous],
    education: [customer, agent, admin, superAdmin, anonymous],
    status: [customer, agent, admin, superAdmin, anonymous],
